/* global twentyTwentyComboBgColors, twentyTwentyColor, jQuery, wp, _ */
/**
	...
	wp.customize.bind( 'ready', function() {
		...
		wp.customize( 'accent_hue', function( value ) {
			value.bind( function( to ) {
				...
				Object.keys( twentyTwentyComboBgColors ).forEach( function( context ) {
					var backgroundColorValue;
					if ( twentyTwentyComboBgColors[ context ].color ) {
						backgroundColorValue = twentyTwentyComboBgColors[ context ].color;
					} else {
						backgroundColorValue = wp.customize( twentyTwentyComboBgColors[ context ].setting ).get();
					}
		...
		Object.keys( twentyTwentyComboBgColors ).forEach( function( context ) {
			wp.customize( twentyTwentyComboBgColors[ context ].setting, function( value ) {
				value.bind( function( to ) {
