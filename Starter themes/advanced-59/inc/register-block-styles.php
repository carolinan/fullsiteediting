...
function full_site_editing_register_block_styles() {
	...
	register_block_style( // phpcs:ignore WPThemeReview.PluginTerritory.ForbiddenFunctions.editor_blocks_register_block_style
		...
		array(
			...
			'label' => __( 'Sticky menu button', 'full-site-editing' ),
		)
	);
	...
	register_block_style( // phpcs:ignore WPThemeReview.PluginTerritory.ForbiddenFunctions.editor_blocks_register_block_style
		'core/navigation',
		array(
			'name'  => 'full-site-editing-navigation-button-shadow',
			'label' => __( 'Button with shadow', 'full-site-editing' ),
		)
	);
	...
	register_block_style( // phpcs:ignore WPThemeReview.PluginTerritory.ForbiddenFunctions.editor_blocks_register_block_style
		'core/site-title',
		array(
			'name'  => 'full-site-editing-text-shadow',
			'label' => __( 'Text shadow', 'full-site-editing' ),
		)
	);
