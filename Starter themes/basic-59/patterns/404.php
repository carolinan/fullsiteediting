...
return array(
	...
	'inserter'   => false,
	'content'    => '
		<!-- wp:heading {"textAlign":"center","fontSize":"x-large"} --><h2 class="has-text-align-center has-x-large-font-size">' . esc_html__( 'Page not found', 'full-site-editing' ) . '</h2><!-- /wp:heading -->
