...
<p class="has-extra-small-font-size"><?php esc_html_e( 'Copyright', 'full-site-editing' );
echo ' ' . date_i18n( _x( 'Y', 'copyright date format', 'full-site-editing' ) ); ?></p><!-- /wp:paragraph -->
