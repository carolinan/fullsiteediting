...
<div class="wp-block-group">
	...
	<p class="has-extra-small-font-size"><?php echo esc_html__( 'Copyright', 'full-site-editing' ) . ' ' . date_i18n( _x( 'Y', 'copyright date format', 'full-site-editing' ) ); ?></p><!-- /wp:paragraph -->
