...
require 'inc/dbtablelogic.inc.php';
...
*/
		...
		// BREAK FROM PHP code to write HTML block. Resume PHP @ line ~76
?>
...
<?php
	...
	// BREAK FROM PHP for writing HTML block
	// RESUME php @ line ~125
?>
	<dl id="outerDL">
...
<div class="centered">
	...
	if(isset($_POST['gettable'])){
		if($_POST['tableName']=='adb_settings'){
			print '<h1>TEMP MSG: invokeAdbSetup html here:</h1>';
			print $invokeAdbSetup;
			var_dump($invokeAdbSetup);
	
		}
		else {
			
		
					// BREAK FROM php code - RESUME @ line ~174
			?>
			<form id="urlSelector" action="<?php print $_SERVER['PHP_SELF']; ?>" method="post">
			<table>
			<tbody>
	...
	// BREAK FROM php code for HTML markup - RESUME @ line ~201
	?>
